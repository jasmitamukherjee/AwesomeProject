  ...
  return (
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
     <View style={{padding:10,flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
      <Text style={{fontSize: 15, fontWeight: '500', color: '#502b63'}}>
        View All
      </Text>
      <Text style={{fontSize: 16, fontWeight: 'bold', color: '#502b63'}}>
        Prompts
      </Text>
     </View>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <View
              ...
              <TextInput
                ...
                style={{color: 'black', width: 300, fontSize: answer ? 18 : 18}}
