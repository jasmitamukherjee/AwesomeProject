    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <ScrollView>
        <View style={{ flex: 1, marginTop: 90, marginHorizontal: 20 }}>
          ...
          <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'black', marginTop: 15 }}>What does your company offer?</Text>
          <Text style={{ marginTop: 30, fontSize: 15, color: 'gray' }}>Select all that apply to your company.</Text>
