...
const LookingFor = () => {
  ...
  const options = [
    ...
    {
      label: 'References and Recommendations',
      subOptions: ['Previous employer references', 'Colleague recommendations', 'Character verification'],
    },
  ];
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <ScrollView>
        <View style={{ flex: 1, marginTop: 90, marginHorizontal: 20 }}>
          ...
          <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'black', marginTop: 15 }}>What are you looking for in an employee?</Text>
